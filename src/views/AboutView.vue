<template>
  <main
    ...
    class="min-h-full">
    <div class="container mx-auto pt-12 md:pt-20 px-6 md:px-10 pb-12">
      <img src="/me.webp" class="w-36 h-36 rounded-full" alt="Photo of me" />
      <h1 class="text-3xl font-bold text-white pt-5">
        Hey,<br class="block md:hidden" />
        I’m Yong Ee
      </h1>
      <div class="pt-2">
        I’m from Singapore
        <img
          src="/sg.svg"
          alt="Singapore Flag"
          class="inline-block h-5 mb-1 rounded-sm overflow-clip" />.
        <br />
      ...
      <div class="pt-7">
        <span class="text-slate-200">Freelance full-stack developer</span>
        <br />
        Since 2019
        <br />
        ...
        <br />
        - Learning management system for the Singapore Government
      </div>
      <div class="pt-8">
        <span class="text-slate-200">DSO National Laboratories</span>
        <br />
        2020–2021
        <br />
      ...
      <div class="pt-8">
        <span class="text-slate-200">LiveStudios Photography</span>
        <br />
        2019
        <br />
